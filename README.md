...
- DNS wildcard function
  ...
  3. (optional) choosing the heartbeat period, the warning notification would pop up to alert users taht short time period may cause low DNS cache performance
  4. go back to dashboard and wait for output.
